...
import { Search, Terminal, Database, Cpu, Settings, LayoutDashboard, X, ArrowRight } from "lucide-react";
...
export default function CommandPalette({ isOpen, onClose, onSelectAction }: CommandPaletteProps) {
  ...
  const actions = [
    ...
    { id: "telemetry", label: "Open Live Swarm Telemetry", category: "Navigation", icon: Terminal },
    { id: "sql-lab", label: "Launch SQL Lab & Query Editor", category: "Data Tools", icon: Database },
    { id: "fleet", label: "Inspect Agent Fleet Manager", category: "AI Management", icon: Cpu },
    { id: "settings", label: "Configure Global Settings", category: "System", icon: Settings },
  ];
