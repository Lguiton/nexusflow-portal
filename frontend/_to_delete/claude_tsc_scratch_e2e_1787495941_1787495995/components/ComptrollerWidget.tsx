  ...
  const runLedgerAudit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Defensive mapping: AI sometimes returns the payload flat instead of nested.
        // This ensures your UI gets the data regardless of how Agent #12 formats it.
        const safeReport = data.audit_report || data;
    ...
    <div className="w-full bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-md text-slate-100 mt-6">
      ...
      {report ? (
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-slate-950 p-4 rounded-lg border border-slate-800">
              ...
              <div className="space-y-1">
                {report.expense_breakdown_by_category && Object.entries(report.expense_breakdown_by_category).map(([cat, total]) => (
          ...
          {report.flagged_items && report.flagged_items.length > 0 && (
